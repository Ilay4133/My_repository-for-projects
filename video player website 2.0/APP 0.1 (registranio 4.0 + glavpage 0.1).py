...
def main(page):
    ...
    page.vertical_alignment1 = ft.MainAxisAlignment.START
    page.horizontal_alignment1 = ft.CrossAxisAlignment.START
    ...
    icon_home=ft.IconButton(ft.icons.ADOBE_SHARP,icon_size=60,icon_color="red500")
    ...
    page.add(ft.Row([icon_home, poisk, icon_poisk, exit_acaunt, admin_set], page.vertical_alignment1,
                    page.horizontal_alignment1))
    Glavpage.del3(1)
