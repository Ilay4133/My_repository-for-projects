...
def entry_user():
    with open('Users_DATA_File.txt', 'r', encoding='utf-8') as f:
        for line in f:
            if line == geting_check_user_nickname:
                print(1)
...
def main(page):
    ...
    def get_check_user_nickname():
        ...
        geting_check_user_nickname=txt_check_nickname.label
        return geting_check_user_nickname

    def get_chack_user_password():
        global geting_chack_user_password
        geting_chack_user_password=txt_check_pasword.label
        return geting_chack_user_password
